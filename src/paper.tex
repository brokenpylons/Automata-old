...
\begin{align*}
  ...
  t &= \Char{a} \Seq \Char{c} \Seq \Char{d} \\
  r &= s \Union p \Union t \\
\end{align*}
...
\begin{align*}
  ...
  \Kleene{s} &\equiv \Null \Union \KleenePlus{s} \equiv \Opt{(\KleenePlus{s})} \equiv \KleenePlus{(\Opt{s})}
\end{align*}
...
\begin{align*}
  ...
  k &= \Char{a} \Seq \Char{b} \Union \Char{a} \Seq \Char{b} \Seq \Char{c} \Union \Char{a} \Seq \Char{c} \Seq \Char{d}\\
  r &= i \Union k
\end{align*}
