...
\begin{equation*}
  \begin{aligned}[t]
    ...
    \NT{I} &\Arrow \T{i}\\[1em]
    \NT{Box} &\Arrow \T{lbrac} \Spc \NT{Val} \Spc \T{rbrac}\\
...
\begin{equation*}
  \begin{aligned}[t]
    ...
    \NT{Box} &\Arrow \T{lbrac} \Spc \NT{Numbers} \Spc \T{rbrac}\\
    \NT{Numbers} &\Arrow \T{num} \Spc \NT{Numbers'}\\
    \NT{Numbers'} &\Arrow \T{sep} \Spc \T{num} \Spc \NT{Numbers'} \Union \Null\\[1em]
    \T{num} &= \KleenePlus{\{\Char{0}, \dots, \Char{9}\}}\\
    \T{lbrac} &= \Char{[}\\
...
\begin{equation*}
  \begin{aligned}[t]
    ...
    \NT{I} &\Arrow \T{i}\\
    \NT{Box} &\Arrow \T{lbrac} \Spc \NT{Box} \Spc \T{rbrac} \Union \NT{Val}\\
    \NT{Val} &\Arrow \T{num} \Union \T{star}\\[1em]
    \T{num} &= \KleenePlus{\{\Char{0}, \dots, \Char{9}\}}\\
    \T{lbrac} &= \Char{[}\\
    \T{rbrac} &= \Char{]}\\
...
\begin{equation*}
  \begin{aligned}[t]
    ...
    \NT{Val} &\Arrow \T{num} \Union \T{lbrac} \Spc \NT{Numbers} \Spc \T{rbrac}\\[1em]
    \T{num} &= \KleenePlus{\{\Char{0}, \dots, \Char{9}\}}\\
    \T{lbrac} &= \Char{[}\\
    \T{rbrac} &= \Char{]}\\
    \T{sep} &= \Char{+}
...
\begin{equation*}
  ...
  \end{aligned}
\end{equation*}
Izjave so zelo podobne seznamom, le da imamo različeno vrsto celice za vsak ukaz.
...
\begin{equation*}
  \begin{aligned}
    ...
    Info &\Arrow Location \Seq \KleenePlus{User}\\
    Location &\Arrow location(Building \Seq Room)\\
    User &\Arrow user(Name \Seq Surname \Seq \Opt{Role})\\
    Desk &\Arrow Info \Seq standing(Standing)\\
    Chair &\Arrow Info\\
    Computer &\Arrow Info \Seq Cpu \Seq Ram \Seq Disk\\
    Name &\Arrow text()\\
    Surname &\Arrow text()\\
    Role &\Arrow text()\\
    Building &\Arrow text()\\
