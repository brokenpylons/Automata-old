...
\begin{align*}
  \NT{Start} &\Arrow \NT{Bitwise}\\
  \NT{Bitwise} &\Arrow \NT{Additive} \Spc \NT{Bitwise'}\\
  \NT{Bitwise'} &\Arrow \T{bwand} \Spc \NT{Additive} \Spc \NT{Bitwise'} \Union \T{bwor} \Spc \NT{Additive} \Spc \NT{Bitwise'} \Union \Null\\[1em]
  ...
  \NT{Primary} &\Arrow \T{int} \Union \T{hex} \Union \T{variable} \Union \T{lparen} \Spc \NT{Bitwise} \Spc \T{rparen}
\end{align*}

\begin{align*}
  \NT{Start} &\Arrow \NT{Bitwise}\\
  \NT{Bitwise} &\Arrow \NT{Additive} \Spc \Kleene{(\T{bwand} \Spc \NT{Additive} \Union \T{bwor} \Spc \NT{Additive})}\\
...
\begin{align*}
  \NT{Start} &\Arrow \NT{Bitwise}\\
  \NT{Bitwise} &\Arrow \NT{Additive} \Spc \Kleene{((\T{bwand} \Union \T{bwor}) \Spc \NT{Additive})}\\
